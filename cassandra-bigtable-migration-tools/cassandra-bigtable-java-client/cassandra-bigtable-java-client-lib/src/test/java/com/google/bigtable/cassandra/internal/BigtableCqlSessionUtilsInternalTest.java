...
public class BigtableCqlSessionUtilsInternalTest {

  private BigtableCqlConfiguration bigtableCqlConfiguration;

  @BeforeEach
  void setup() {
    bigtableCqlConfiguration = BigtableCqlConfiguration.builder()
